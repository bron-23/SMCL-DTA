...
This directory contains the KIBA split CSV files copied from the local source folder `C:\Users\26331\OneDrive\Desktop\data\kiba`.
...
| --- | ---: | --- |
| `standard/all.csv` | 118,254 | Full KIBA interaction table used to derive the standard split. |
...
| `cold_start/kiba_proteins.csv` | 229 | Protein list/metadata used by the KIBA cold-start split. |
